          ...
          <div className="flex items-center justify-between bg-white/80 p-2 rounded-md border border-input h-11">
            ...
            <div className="flex items-center gap-2 shrink-0 h-full">
              <button 
                ...
                className={`w-8 h-8 flex items-center justify-center rounded transition-all ${data.thermal_nc === true ? 'bg-green-500 text-white shadow-md ring-2 ring-green-400' : 'bg-slate-50 text-slate-400 hover:bg-slate-200'}`}
              >
              ...
              <button 
                ...
                className={`w-8 h-8 flex items-center justify-center rounded transition-all ${data.thermal_nc === false ? 'bg-red-500 text-white shadow-md ring-2 ring-red-400' : 'bg-slate-50 text-slate-400 hover:bg-slate-200'}`}
              >
                <X className="w-5 h-5" />
              </button>
            </div>
          ...
          <div className="flex items-center justify-between bg-white/80 p-2 rounded-md border border-input h-11">
            ...
            <div className="flex items-center gap-2 shrink-0 h-full">
              <button 
                ...
                className={`w-8 h-8 flex items-center justify-center rounded transition-all ${data.thermal_no === true ? 'bg-green-500 text-white shadow-md ring-2 ring-green-400' : 'bg-slate-50 text-slate-400 hover:bg-slate-200'}`}
              >
                <Check className="w-5 h-5" />
              </button>
              <button 
                ...
                className={`w-8 h-8 flex items-center justify-center rounded transition-all ${data.thermal_no === false ? 'bg-red-500 text-white shadow-md ring-2 ring-red-400' : 'bg-slate-50 text-slate-400 hover:bg-slate-200'}`}
              >
                <X className="w-5 h-5" />
              </button>
            </div>
