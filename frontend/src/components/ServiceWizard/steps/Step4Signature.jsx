...
const Step4Signature = ({ onSubmit, isSubmitting }) => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
      <div className="flex items-center space-x-3 text-slate-800 border-b border-slate-200/50 pb-4">
        ...
        <h2 className="text-xl font-bold">Observaciones y Firma del Cliente</h2>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4 bg-white/50 p-6 rounded-2xl border border-white/60 shadow-sm flex flex-col">
          ...
          <Textarea 
            placeholder="Ingrese cualquier observación adicional, repuestos requeridos, o recomendaciones..."
        ...
        <div className="space-y-4 bg-white/50 p-6 rounded-2xl border border-white/60 shadow-sm">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="client_signature_name">Nombre de quien recibe el trabajo</Label>
              <Input 
      ...
      <div className="flex justify-between mt-8 pt-6 border-t border-slate-200/50">
        ...
        <Button 
          onClick={onSubmit}
          disabled={isSubmitting || !formData.signature_base64}
        ...
        >
          {isSubmitting ? (
            ...
            <span className="flex items-center">
              <CheckCircle2 className="w-5 h-5 mr-2" /> Finalizar y Guardar
            </span>
          )}
        </Button>
      </div>
